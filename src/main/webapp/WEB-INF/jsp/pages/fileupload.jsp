...
<body>
	...
	<br />
	<form id="form1" method="post" action="/DocuSign/docs/upload"
		enctype="multipart/form-data">

		<!-- File input -->
		<input name="file" id="file" type="file" /><br /> <input
	...
	<!--  Form 2 -->
	<form id="form2" method="post" action="/DocuSign/docs/upload"
		enctype="multipart/form-data">
		<!-- File input -->
